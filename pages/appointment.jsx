...
function Appointments() {
 ...
 const [date, setDate] = useState(new Date());
  ...
  const appointments = [
    ...
    {
      id: 3,
      customer: "drbclakhera@gmail.com",
      phone: "0123456789",
      staff: "DR BC Lakhera",
      service: "Joint and Spine Care",
      price: "0.00",
  ...
  <PopoverTrigger asChild>
    <Button
      variant="outline"
      data-empty={!date}
      className="data-[empty=true]:text-muted-foreground w-full sm:w-[212px] justify-between text-left font-normal bg-white"
    >
